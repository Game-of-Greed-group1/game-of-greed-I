...
class Game:
    ...
    def play(self):
        ...
        play = input(print("(y)es to play or (n)o to decline"))
        ...
        while play:
            ...
            if is_zilch:
                again = input(print("Enter dice to keep, or (q)uit:"))
                ...
                if again == "q":
                    ...
                    if check:
                        ...
                        if value:
                            ...
                            print(
                                f"You have {self.banker.shelved} unbanked points and {remaining_dice} dice remaining"
                            )
                            ...
                            if roll_again == "r":
                                ...
                                print(
                                    f"You banked {self.banker.shelved} points in round {rounds}"
                                )
                                self.banker.bank()
                                print(f"Total score is {self.banker.balance} points")
                                print(
